                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}" >
                                    <tr>
                                        ...
                                        <td class="col-md-1" style="text-align: center">R ${cartItem.product.productPrice}</td>
                                        <td class="col-md-1" style="text-align: center">R ${cartItem.totalPrice}</td>
                                    </tr>
                                </c:forEach>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong>R ${order.cart.grandTotal}</strong></h4>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
